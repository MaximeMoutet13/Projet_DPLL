...
def time_comparison(problem_sizes):
    ...
    # plt.figure()
    # plt.title("Pigeons: différentes heuristiques")
    ...
    # plt.legend(loc='best')
    # plt.savefig("images/pigeon_heuristics.png")
    # plt.show()
...
def tree_comparison(problem_sizes):
    ...
    # plt.figure()
    # plt.title("Pigeons: taille des arbres")
    # plt.xlabel("Taille du problème")
    ...
    # plt.legend(loc='best')
    # plt.savefig("images/pigeon_tree.png")
    # plt.show()
